...
tm_shape(neigh2) +tm_polygons("n",alpha=.5,n=4,style="quantile")
```
...
Guidance taken from: https://www.census.gov/topics/employment/commuting/guidance/calculations.html


We will use method 2:

commutter_adjusted_pop = `total residents` +`total workers working in area` - `total workers living in area`


From page https://www.census.gov/topics/employment/commuting/guidance/calculations/acs-tables.html

census.gov suggests some specific variables.
